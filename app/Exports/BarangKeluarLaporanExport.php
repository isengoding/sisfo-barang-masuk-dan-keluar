...
class BarangKeluarLaporanExport implements FromView, WithEvents, ShouldAutoSize
{
    protected $data;
    ...
    {
        return view('pages.barang-keluar.laporan.excel', [
            'barangKeluarDetails' => $this->getData(),
        ]);
    }
}
