            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('pelanggan.create') }}" class="btn btn-primary d-sm-none btn-icon"
                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <tbody>
                                    @forelse ($pelanggans as $row)
                                        <tr>
                                            ...
                                            <td class="align-text-top" data-label="Nama Pelanggan">
                                                {{ $row->nama_pelanggan }}
                                            </td>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="{{ route('pelanggan.edit', $row->id) }}">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $pelanggans->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
