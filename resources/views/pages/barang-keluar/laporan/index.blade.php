            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('barang-keluar.laporan.pdf', [
                        ...
                        <a href="{{ route('barang-keluar.laporan.excel', [
                            'from_date' => request()->query('from_date'),
                            'to_date' => request()->query('to_date'),
                        ]) }}"
                            target="_blank" class="btn btn-primary d-none d-sm-inline-block">
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Barang">
                                                <div class="d-flex flex-column align-items-top">
                                                    ...
                                                    <div class="font-weight-medium">{{ $row->barangKeluar->tgl_keluar }}
                                                    </div>
                                                    <div class="text-secondary">
                                                        <a href="{{ route('barang-keluar.show', $row->barangKeluar->id) }}"
                                                            target="_blank"
                                                            class="">{{ $row->barangKeluar->no_transaksi }}</a>
                                                    </div>
