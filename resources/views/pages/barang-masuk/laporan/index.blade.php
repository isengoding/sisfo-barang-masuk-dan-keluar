                ...
                <div class="col-12">
                    ...
                    @if (request()->query('from_date'))
                        <div class="mb-3">
                            ...
                            <a class="ms-2 text-reset text-secondary" href="{{ route('barang-masuk.laporan') }}">Reset</a>
                        </div>
                    @endif
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            Total : {{ $barangMasukDetails->count() }}
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Barang">
                                                <div class="d-flex flex-column align-items-top">
                                                    ...
                                                    <div class="font-weight-medium">{{ $row->barangMasuk->tgl_masuk }}
                                                    </div>
                                                    <div class="text-secondary">
                                                        <a href="{{ route('barang-masuk.show', $row->barangMasuk->id) }}"
                                                            target="_blank"
                                                            class="">{{ $row->barangMasuk->no_transaksi }}</a>
                                                    </div>
