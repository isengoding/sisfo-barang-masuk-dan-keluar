        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('satuans.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <a href="{{ route('satuans.create') }}" class="btn btn-primary d-sm-none btn-icon"
                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <tbody>
                                    @forelse ($satuans as $row)
                                        <tr>
                                            ...
                                            <td class="align-text-top" data-label="Nama Satuan">
                                                {{ $row->nama_satuan }}
                                            </td>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="{{ route('satuans.edit', $row->id) }}">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`{{ route('satuans.destroy', $row->id) }}`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $satuans->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
