                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <div class="btn-list">
                                <span class="d-none d-sm-inline">
                                    <a href="{{ route('images.create') }}" class="btn">
                                        New Image
                                    </a>
                                </span>
                        ...
                        @foreach ($images as $row)
                            <div class="col-sm-6 col-lg-4">
                                <div class="card card-sm">
                                    <a href="#" class="d-block"><img src="{{ asset('storage/' . $row->path) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-auto">
                                                <a href="{{ route('images.edit', $row->id) }}" class="text-secondary">
                                                ...
                                                <a href="#" class="ms-3 text-secondary"
                                                    onclick="handleDelete(`{{ route('images.destroy', $row->id) }}`)">
                                                    <!-- Download SVG icon from http://tabler-icons.io/i/heart -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon"
                                                        width="24" height="24" viewBox="0 0 24 24"
                                                        stroke-width="2" stroke="currentColor" fill="none"
